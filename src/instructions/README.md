...
- Откроется окно создания [пакета][5]
  ...
  - метку;
  - переменные [пакета][5] типа "поле", соответствующие параметрам узла (при их наличии);
  - переменные [пакета][5] типа "файл" загрузив произвольные файлы из файловой системы.
