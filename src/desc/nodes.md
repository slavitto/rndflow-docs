...
2. [Ручном не интерактивном](/docs/instructions/package.md#обработка-пакета)
   ...
   Пакет отправляется на первичную или повторную обработку пользователемя вручную.

3. [Ручном интерактивном](/docs/instructions/package.md#интерактивная-обработка-пакета)

   Пакет отправляется на первичную или повторную обработку интерактивную обработку пользователем вручную.
