...
- <span class="iconify-inline" data-icon="mdi:server"></span> [Cервер расчетов](./executor.md) - выбранный основной сервер расчетов для проекта, его описание и статус (зеленый - активен, оранжевый - приостановлен, красный - выключен).
